//This User model is created by our own API - first we select the data and move to the webhook site to create a fake api then we copy the link of the api and post it to the postman and hit the get and then select all the data and created a model here by  using the plugins
class UserModel {
  UserModel({
      num? id, 
      String? name, 
